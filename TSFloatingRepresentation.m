...
static NSString *infoText = @"Расположите корабли на поле так, что бы при размещении они не касались друг друга углами. При двойном касании, корабль разворачивается на 90 градусов. Стреляйте когда стрелка становится зеленого цвета. Убитый или раненный корабль отмечается красным квадратом, выстрел мимо - серым...\n                               Удачи!!!";
